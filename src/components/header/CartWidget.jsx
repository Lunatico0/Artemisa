...
const CartWidget = () => {
  ...
  return (
    ...
    >
      ...
      >
        {cantidad != 0 ? cantidad : ""}
        <span className={`md:text-[32px] text-2xl pt-2 ${mostrarBefore && 'before:contents before:absolute before:bg-textoLogo before:rounded-full before:h-3 before:w-3 before:top-1/4 before:left-8'}`}>
